...
def get_network(image_size, widths, block_depth, num_classes,
                num_channels, emb_size, attention_levels, precomputed_embedding=True):
  ...
  return keras.models.Model([noisy_images, noise_variances, input_label], x, name="residual_unet")